...
var _ = Describe("AgentControlPlane Controller", func() {
	Context("When reconciling a resource", func() {
		...
		agentcontrolplane := &controlplanev1.AgentControlPlane{}
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &controlplanev1.AgentControlPlane{
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance AgentControlPlane")
